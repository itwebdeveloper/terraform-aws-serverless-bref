...
module "aws_resource_simple_app" {
  ...
  cloudwatch_private_notifications                    = var.sns_jira_workload_notifications_users
  ...
  sns_topic_subscription_jira_workload_manager_email  = var.sns_topic_subscription_jira_workload_manager_email
